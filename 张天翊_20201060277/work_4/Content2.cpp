...
polypoint[POINTNUM]= {200,30,420,150,460,300,280,250,120,350,30,200}; //多边形顶点
...
void PolyScan()
{
    ...
    glColor3f(0.3,0.4,0.1);             //设置直线的颜色红色
    glBegin(GL_POINTS);
    /**扫描并建立NET表**/
    for(i=0; i<=MaxY; i++)
    {
...
int main(int argc,char** argv)
{
    ...
    glutCreateWindow("Generation of green hexagons");//创建显示窗口
